...
public class Facturador extends JFrame {
	...
	private JLabel listaJLabels[];// zone items
	private int indiceItems;//
	private int totalFactura;// numero entero global para almacenar el valor total
	...
	// Metodos
	public Facturador(Usuario[] listausuario, Producto[] listaProductos) {
	...
	public void initComponent() {
		...
		KeyListener evento_key_id = new KeyListener() {
			public void keyPressed(KeyEvent e) {
			}
		...
		input_id_producto.addKeyListener(evento_key_id);
	...
	public void buscarCliente() {
		// Extraer la cedula del input
		// Recorrer el arreglo con un for
		// si.
		// Modificar los campos asignando datos
